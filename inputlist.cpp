...
static struct {
    ...
    int     type;
    int     pin;
} InputSeenPreviously[MAX_IO_SEEN_PREVIOUSLY];
static int InputSeenPreviouslyCount;

static struct {
    char    name[MAX_NAME_LEN];
    int     type;
    int     pin;
} OutputSeenPreviously[MAX_IO_SEEN_PREVIOUSLY];
static int OutputSeenPreviouslyCount;
