...
static LangTable LangPtTable[] = {
    ...
    { "Can only assign pin number to input/output pins (Xname or Yname or Aname).", "Somente pode atribuir números dos pinos aos pinos de Entrada/Saída (Xname, Yname, Aname, Ename, Zname, Gname or Wname)." },
