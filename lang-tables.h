...
static LangTable LangDeTable[] = {
    ...
    { "Can only assign pin number to input/output pins or general variable.", "Nur für Ein- und Ausgangspins können Pin-Nummern vergeben werden." },
    ...
    { "POPTools - Simulation (Running)", "POPTools - Simulation (am Laufen)" },
    { "POPTools - Simulation (Stopped)", "POPTools - Simulation (Angehalten)" },
    { "POPTools - Program Editor", "POPTools – Programm-Editor" },
    ...
    { "Insert Rung &Before\tShift+INS", "Netzwerk Einfügen &Davor\tShift+INS" },
    { "Insert Rung &After\tINS", "Netzwerk Einfügen &Danach\tINS" },
    ...
    { "Insert Co&mment\tF2", "Kommentar &einfügen\tF2" },
    ...
    { "Insert CT&U (Count Up)\tI", "CT&U einfügen (Aufwärtszähler)\tU" },
    { "Insert CT&D (Count Down)\tU", "CT&D einfügen (Abwärtszähler)\tI" },
    ...
    { "Constant %d out of range: -2147483648 to 2147483647 inclusive.", "Konstante %d außerhalb des Bereichs: -32768 bis 32767 inklusive." },
    ...
    { "File format error; perhaps this program is for a newer version of POPTools?", "Fehler beim Dateiformat; vielleicht ist dies ein Programm für eine neuere Version von LDmicro." },
    { "Index:", "Liste:" },
    { "Points:", "Punkte:" },
    { "Count:", "Berechnung:" },
    ...
    { "POPTools Error", "Fehler POPTools" },
...
static LangTable LangEsTable[] = {
    ...
    { "Can only assign pin number to input/output pins or general variable.", "Solo puede asignar numero de pata a las patas de Entrada/Salida." },
    ...
    { "POPTools - Simulation (Running)", "POPTools - Simulación (Ejecutando)" },
    { "POPTools - Simulation (Stopped)", "POPTools - Simulación (Parada)" },
    { "POPTools - Program Editor", "POPTools – Editor de Programa" },
    ...
    { "Insert Rung &Before\tShift+INS", "Insertar Línea (Rung) &Antes\tShift+INS" },
    { "Insert Rung &After\tINS", "Insertar Línea (Rung) &Despues\tINS" },
    ...
    { "Insert Co&mment\tF2", "Insertar Co&mentario\tF2" },
    ...
    { "Insert CT&U (Count Up)\tI", "Insertar CT&U (Contador Incremental)\tU" },
    { "Insert CT&D (Count Down)\tU", "Insertar CT&D (Contador Decremental)\tI" },
...
static LangTable LangFrTable[] = {
    ...
    { "Can only assign pin number to input/output pins or general variable.", "Vous pouvez uniquement affecter les broches Entrées/Sorties." },
    ...
    { "POPTools - Simulation (Running)", "POPTools - Simulation (en cours)" },
    { "POPTools - Simulation (Stopped)", "POPTools - Simulation (Arrétée)" },
    { "POPTools - Program Editor", "POPTools – Edition du programme " },
    ...
    { "Insert Rung &Before\tShift+INS", "Insérer ligne avant\tShift+INS" },
    { "Insert Rung &After\tINS", "Insérer ligne &après\tINS" },
    ...
    { "Insert Co&mment\tF2", "Insérer commentaire\tF2" },
    ...
    { "Insert CT&U (Count Up)\tI", "Insérer CT&U (Compteur)\tU" },
    { "Insert CT&D (Count Down)\tU", "Insérer CT&D (Décompteur)\tI" },
...
static LangTable LangItTable[] = {
    ...
    { "Can only assign pin number to input/output pins or general variable.", "Assegnare unicamente il numero di pin input/output (XNome, YNome ou ANome)." },
    ...
    { "POPTools - Simulation (Running)", "POPTools - Simulazione (in corso)" },
    { "POPTools - Simulation (Stopped)", "POPTools - Simulazione (Ferma)" },
    { "POPTools - Program Editor", "POPTools - Scrivere il programma" },
    ...
    { "Insert Rung &Before\tShift+INS", "Inserire Ramo &Davanti\tShift+INS" },
    { "Insert Rung &After\tINS", "Inserire Ramo &Dietro\tINS" },
    ...
    { "Insert Co&mment\tF2", "Inserire Co&mmento\tF2" },
    ...
    { "Insert CT&U (Count Up)\tI", "Inserire CT&U (Contatore Up)\tU" },
    { "Insert CT&D (Count Down)\tU", "Inserire CT&D (Contatore Down)\tI" },
...
static LangTable LangPtTable[] = {
    ...
    { "Source", "Fonte" },
    { "Internal Relay", "Rele Interno" },
    { "Input pin", "Entrada Digital" },
    { "Output pin", "Saida Digital" },
    { "|/| Negated", "|/| Negado" },
    { "Contacts", "Contatos" },
    ...
    { "Can only assign pin number to input/output pins or general variable.", "Somente pode atribuir números dos pinos aos pinos de Entrada/Saída ou Variável de Uso Geral." },
    ...
    { "Name", "Nome" },
    { "State", "Estado" },
    { "Pin on Processor", "Nro Porta E/S" },
    { "MCU Port", "Porta do PLC" },
    { "POPTools - Simulation (Running)", "POPTools - Simulação (Executando)" },
    { "POPTools - Simulation (Stopped)", "POPTools - Simulação (Parado)" },
    { "POPTools - Program Editor", "POPTools" },
    ...
    { "Insert Rung &Before\tShift+INS", "Inserir Linha (Rung) &Antes\tShift+INS" },
    { "Insert Rung &After\tINS", "Inserir Linha (Rung) &Depois\tINS" },
    ...
    { "Insert Co&mment\tF2", "Inserir Co&mentário\t;" },
    ...
    { "Insert CT&U (Count Up)\tI", "Inserir CT&U (Contador Incremental)\tI" },
    { "Insert CT&D (Count Down)\tD", "Inserir CT&D (Contador Decremental)\tD" },
    { "Insert CT&C (Count Circular)\tShift+C", "Inserir CT&C (Contador Circular)\tShift+C" },
    ...
    { "Insert DIV (16-bit Integer Divide)\tShift+/", "Inserir DIV (Divide Inteiro 16-bit)\tShift+/" },
    ...
    { "Send Formatted String Over UART", "Escrita de String Formatada na Serial RS485" },
    { "Receive Formatted String Over UART", "Leitura de String Formatada na Serial RS485" },
    { "Insert &UART Send", "Enviar caracter RS-485" },
    { "Insert &UART Receive", "Receber caracter RS-485" },
    { "Insert Set PWM Output\tW", "Inserir Valor de Saída PWM\tW" },
    { "Insert A/D Converter Read\tCtrl+A", "Inserir Leitura do Conversor A/D\tCtrl+A" },
    ...
    { "&MCU Parameters...", "&Parâmetros do PLC..." },
    ...
    { "&Halt Simulation\tCtrl+H", "Parar Simulação em Tempo Real\tCtrl+H" },
    ...
    { "cycle time %.2f ms", "tempo de ciclo %.0f ms" },
    { "processor clock %.4f MHz", "clock do processador %.0f MHz" },
    ...
    { "Turn-On Delay", "Atraso Ligar" },
    { "Turn-Off Delay", "Atraso Desligar" },
    { "Retentive Turn-On Delay", "Atraso com memória" },
    { "Delay (ms):", "Tempo (ms):" },
    ...
    { "Name:", "Nome:" },
    { "Stages:", "Fases:" },
    { "Shift Register", "Fila de Variáveis" },
    { "Not a reasonable size for a shift register.", "Não é um tamanho razoável para uma fila de variáveis." },
    { "String:", "String:" },
    ...
    { "Cannot delete rung; program must have at least one rung.", "Não pode apagar a Linha (rung); O programa deve conter ao menos uma Linha (rung)." },
    ...
    { "Timer period too long (max 2147483647 times cycle time); use a slower cycle time.", "Tempo do Temporizador muito grande(max. 2147483647 tempo de ciclo); use um tempo de ciclo menor." },
    { "Constant %d out of range: -2147483648 to 2147483647 inclusive.", "Constante %d fora do range: -2147483648 a 2147483647 inclusive." },
    { "Move instruction: '%s' not a valid destination.", "Instrução Mover: o destino '%s' não é válido." },
    { "Math instruction: '%s' not a valid destination.", "Instruções Math: o destino '%s' não é válido." },
    { "Math instruction: '%s' divided by zero!", "Instruções Math: '%s' dividido por zero!" },
    ...
    { "File format error; perhaps this program is for a newer version of LDmicro?", "Erro no formato de arquivo; talvez este programa é para uma versão mais nova do POPTools?." },
    { "Index:", "Índice:" },
    { "Points:", "Pontos:" },
    { "Count:", "Contador:" },
    ...
    { "retentive timer", "Atraso com memória" },
    { "counter", "contador" },
    ...
    { "<no UART!>", "<sem UART!>" },
    { "<no PWM!>", "<sem PWM!>" },
    { "TOF: variable cannt be used elsewhere", "TOF: a variável não pode ser usada em outra parte" },
	...
	{ "About LDmicro", "Sobre POPTools" },
	{ "POPTools Help", "Ajuda POPTools" },
	{ "", "'%s' deve ser número!" },
	{ "", "'%s' fora dos limites! Deve estar entre %d e %d." },
	{ "", "'%s' não pode ser número!" },
	{ "", "'Nome' deve ser um contador ou timer!" },
	...
	{ "", "(GMT-01:00) Açores, Cabo Verde" },
	{ "", "(GMT-02:00) Atlântico Central" },
	{ "", "(GMT-03:00) Brasilia, Buenos Aires" },
	{ "", "(GMT-04:00) Rio Branco, Manaus, Caracas, La Paz" },
	{ "", "(GMT-05:00) Lima, Bogotá" },
	{ "", "(GMT-06:00) América Central, Hora Central EUA/Canadá" },
	{ "", "(GMT-07:00) Hora das Montanhas (EUA e Canadá)" },
	{ "", "(GMT-08:00) Hora do Pacífico" },
	{ "", "(GMT-09:00) Alasca" },
	{ "", "(GMT-10:00) Hawaí" },
	{ "", "(GMT-11:00) Ilhas Midway,Samoa" },
	{ "", "(GMT-12:00) Linha de Data Internacional Oeste" },
	{ "", "(GMT 00:00) Hora de Greenwich: Londres, Dublin, Lisboa" },
	{ "", "(GMT+01:00) Berlim, Estocolmo, Roma, Bruxelas" },
	{ "", "(GMT+02:00) Atenas, Helsinque, Leste Europeu, Jerusalém" },
	{ "", "(GMT+03:00) Bagdá, Kuwait, Nairóbi, Moscou,Riad" },
	{ "", "(GMT+04:00) Abu Dhabi, Mascate, Hora Padrão do Cáucaso" },
	{ "", "(GMT+05:00) Islamabad, Karachi, Ekaterinburgo" },
	{ "", "(GMT+06:00) Almaty, Dacca" },
	{ "", "(GMT+07:00) Bangcoc, Jacarta, Hanói" },
	{ "", "(GMT+08:00) Pequim, Hong Kong, Taiwan, Cingapura" },
	{ "", "(GMT+09:00) Tóquio, Osaka, Sapporo, Seul, Yakutsk" },
	{ "", "(GMT+10:00) Brisbane, Camberra, Melbourne, Sydney" },
	{ "", "(GMT+11:00) Magadã, Ilhas Salomão, Nova Caledônia" },
	{ "", "(GMT+12:00) Fiji, Kamchatka, Auckland" },
	{ "", "(GMT+13:00) Nuku'alofa" },
	{ "[\x01OSF\x02 \\_]", "[\x01""BRD\x02 \\_]" },
	{ "[\x01OSR\x02_/ ]", "[\x01""BRD\x02_/ ]" },
	{ "[END]", "[FIM]" },
	{ "", "\nDiagrama Ladder:\n\n" },
	{ "", "{%s BIT:%d}" },
	{ "", "{%s MOV}" },
	...
	{ "", "{\x01SHIFT REG\x02   }" },
	{ "", "{ACELERACAO}" },
	{ "{CHECK %s:%d}", "{CHECAR %s:%d}" },
	{ "", "{DESACELERACAO}" },
	{ "{MASTER RLY}", "{CHAVE GERAL}" },
	{ "", "{PERSIST}" },
	{ "{PWM %.1f kHz}", "{PWM %.1f kHz}" },
	{ "{PWM %.2f kHz}", "{PWM %.2f kHz}" },
	{ "{PWM %d Hz}", "{PWM %d Hz}" },
	{ "", "{PWM %d kHz}" },
	{ "{READ ADC %s }", "{LER A/D %s }" },
	{ "", "{READ ENC}" },
	{ "", "{READ MB 485}" },
	{ "", "{READ MB ETH}" },
	{ "", "{READ USS}" },
	...
	{ "", "Arquivos de Texto (*.txt)\0*.txt\0Todos os Arquivos\0*\0\0" },
	{ "", "Atualizando o relógio RTC da POP..." },
	{ "", "Avançar" },
	{ "", "Aviso" },
	{ "", "Aviso: Este projeto não pode ser aberto porque foi gravado com uma versão mais nova do programa POPTools !" },
	{ "", "Aviso: O arquivo deste projeto é de uma versão anterior e será atualizado para a versão atual quando for gravado !" },
	{ "", "Avisos durante a simulação" },
	{ "", "Bit:" },
	{ "", "char" },
	{ "", "Comando inválido durante a gravação do programa !" },
	{ "", "Comando inválido enviado ao apagar a memória flash !" },
	{ "", "Compilado com sucesso. O arquivo binário foi criado em '%s'.\r\n\r\n" },
	{ "", "Compilando... aguarde !" },
	{ "", "Conexão cancelada !" },
	{ "", "Configurações" },
	{ "", "Confirmar alteração de Entrada para Relé Interno" },
	{ "", "Confirmar alteração de Entrada para Saída" },
	{ "", "Confirmar alteração de Rele Interno para Saída" },
	{ "", "Confirmar alteração de Saída para Rele Interno" },
	{ "", "Conflito entre tipos! Operação não permitida." },
	{ "", "Connection closed" },
	{ "", "Could not load splash image!" },
	{ "", "CTD" },
	{ "", "CTU" },
	{ "", "Curva" },
	{ "", "Curva de Ganho" },
	...
	{ "", "DIV\x02" },
	{ "", "Divisão por zero na variavel: '%s', a simulação será interrompida." },
	{ "", "DNS" },
	{ "", "DNS:" },
	{ "", "DSTQQSS" },
	{ "", "duty_cycle" },
	...
	{ "", "Endereço:" },
	{ "", "entrada encoder" },
	{ "", "Enviado comando inválido (conectando) !" },
	{ "", "Enviado comando inválido (verificando) !" },
	{ "", "ERRO" },
	{ "", "Erro abrindo porta serial!" },
	{ "", "Erro ao abrir o arquivo de programa (.hex) !" },
	{ "", "Erro ao conectar na porta COM%d !" },
	{ "", "Erro ao gerar checksum durante a gravação do programa !" },
	{ "", "Erro ao preencher a memória flash !" },
	{ "", "Erro de checksum ao gravar o programa !" },
	{ "", "Erro de checksum no arquivo de programa (.hex) !" },
	{ "", "Erro durante a gravação do programa !" },
	{ "", "Erro na compilacao !!!" },
	{ "", "Erro na execução do módulo JIT !" },
	{ "", "Erro na verificação !" },
	{ "", "Escrever" },
	{ "", "escrita modbus" },
	{ "", "escrita modbus eth" },
	...
	{ "", "Fuso Horário:" },
	{ "", "Gateway:" },
	{ "", "Gravando... %d%% concluído !" },
	{ "", "Gravação concluída com sucesso" },
	{ "", "Gravação concluída com sucesso !" },
	{ "", "Gravação do programa cancelada !" },
	{ "", "GW" },
	{ "", "Hora invalida, deve estar entre 0 e 23." },
	{ "", "Horário de verão" },
	{ "", "ID" },
	{ "", "ID deve ser maior ou igual a zero!" },
	{ "", "ID:" },
	{ "", "Impossível criar paralelo entre os pontos selecionados!" },
	{ "in", "entrada" },
	{ "", "index" },
	{ "", "Indice" },
	{ "", "Indice:" },
	{ "", "Intel Hex Files (*.hex)\0*.hex\0All files\0*\0\0" },
	{ "", "Interface" },
	{ "", "IP" },
	{ "", "IP:" },
	{ "", "Janeiro" },
	{ "", "Já existe um Rele Interno com este nome. Alterar para Saída?" },
	{ "", "Já existe uma Entrada com este nome. Alterar para Relé Interno?" },
	{ "", "Já existe uma Entrada com este nome. Alterar para Saída?" },
	{ "", "Já existe uma Saída com este nome. Alterar para Rele Interno?" },
	{ "", "Julho" },
	{ "", "Junho" },
	{ "", "leitura modbus" },
	{ "", "leitura modbus eth" },
	{ "", "leitura NS600" },
	{ "", "Ler" },
	{ "", "Ler Parâmetro por USS" },
	{ "", "Ligado" },
	{ "", "Ligar" },
	{ "", "Limpar Registro" },
	{ "", "Limpar!" },
	{ "", "Limpeza da memória flash cancelada !" },
	{ "", "Limpeza da memória flash não suportado !" },
	{ "", "Linear" },
	{ "", "Linguagem C (*.c)\0*.c\0Todos os Arquivos\0*\0\0" },
	{ "", "Localizar" },
	...
	{ "", "Mascara:" },
	{ "", "MASK" },
	{ "", "Minuto invalido, deve estar entre 0 e 59." },
	{ "", "Modbus" },
	{ "", "ModBUS ID:" },
	...
	{ "", "Nao encontrado!" },
	{ "new", "novo" },
	{ "", "No Encoder or Encoder not supported for selected micro." },
	{ "", "Nome" },
	{ "", "Nome '%s' reservado para uso interno, favor escolher outro nome." },
	{ "", "Nome Inválido! Para o tipo 'Flag Interna' é obrigatório selecionar um item da lista." },
	{ "", "Não" },
	{ "", "Não foi possível abrir o arquivo .hex ao apagar a memória flash !" },
	{ "", "Não foi possível alocar memória durante a gravação do programa !" },
	{ "", "Não foi possível conectar com baudrate %i !" },
	{ "", "Não foi possível conectar para apagar a memória flash !" },
	{ "", "Não foi possível conectar para gravar o programa !" },
	{ "", "Não suporta gravação do programa !" },
	{ "", "Não suporta verificação !" },
	{ "", "Novembro" },
	{ "", "Novo Valor" },
	{ "", "O valor máximo permitido para o campo Resolução (%%) da Curva de Ganho é %s." },
	{ "", "O valor máximo permitido para o campo Tempo (%%) da Curva de Ganho é %d." },
	{ "", "O valor permitido para o campo Resolução DA no Tamanho da Rampa esta entre %d e %d." },
	{ "", "O valor permitido para o campo Tempo (ms) no Tamanho da Rampa esta entre %d e %d." },
	{ "", "Ocorreu um erro ao desenhar o gráfico do D/A." },
	{ "", "Ocorreu um erro desconhecido ao apagar a memória flash !" },
	{ "", "Ocorreu um erro desconhecido ao conectar !" },
	{ "", "Ocorreu um erro desconhecido ao desconectar !" },
	{ "", "Ocorreu um erro desconhecido ao gravar o programa !" },
	{ "", "Ocorreu um erro desconhecido ao verificar a gravação do programa !" },
	{ "", "OFF" },
	{ "", "ON" },
	{ "", "Operação" },
	{ "", "Operação bit" },
	...
	{ "out", "saida" },
	{ "", "Outubro" },
	{ "", "Para '%s', cristal de %.6f MHz, tempo de ciclo de %.1f ms\n\n" },
	{ "", "Parametro:" },
	{ "", "Parametros de conexão inválidos !" },
	{ "", "Parametros inválidos ao apagar a memória flash !" },
	{ "", "Parâmetro" },
	{ "", "POP-7 não encontrada!" },
	{ "", "POPTools - Texto exportado\n" },
	{ "", "POPTools !" },
	{ "", "POPTools iniciado" },
	{ "", "POPTools Projeto Ladder (*.ld)\0*.ld\0All files\0*\0\0" },
	{ "", "Porta de Depuração:" },
	{ "", "Porta de Gravação:" },
	{ "", "Posicionamento" },
	{ "", "Preferências" },
	{ "", "Preparando para gravar... %d%% concluído !" },
	...
	{ "", "reg" },
	{ "", "Registrador" },
	{ "", "Registrador deve ser entre 0 e 31!" },
	{ "", "Registrador:" },
	{ "", "Registro" },
	{ "", "Relógio da POP" },
	{ "", "Reset" },
	{ "", "reset encoder" },
	{ "", "Resolução DA (%):" },
	{ "", "Resolução DA (%)[-100 ~ 100]" },
	{ "", "Resolução DA (%)[0 ~ 100]" },
	{ "", "Resolução DA (12 bits)[-2048 ~ 2047]" },
	{ "", "Resolução DA (12 bits)[2047 ~ -2048]" },
	{ "", "Resolução DA (mV)[-10000 ~ 10000]" },
	{ "", "Resolução DA (mV)[10000 ~ -10000]" },
	{ "", "Resposta" },
	{ "", "Retransmitir" },
	{ "", "Retransmitir Pacote" },
	...
	{ "", "RX NS600" },
	{ "", "Sair" },
	{ "", "Salvar como linguagem C" },
	{ "", "saved" },
	{ "", "Saída em uso! Não é possível alterar para Entrada." },
	{ "", "Segundo invalido, deve estar entre 0 e 59." },
	{ "", "Serial" },
	{ "", "Servidor de Tempo:" },
	{ "", "Servo Yaskawa" },
	{ "", "SET" },
	...
	{ "", "Valor" },
	{ "", "Valor inválido no campo Resolução (%) !" },
	{ "", "Valor inválido no campo Resolução DA !" },
	{ "", "Valor inválido no campo Tempo (%) !" },
	{ "", "Valor inválido no campo Tempo (ms) !" },
	{ "", "Valor inválido! Conflito de tipos: Entrada <-> Saída" },
	{ "", "Valor inválido! Conflito de tipos: Rele Interno <-> Entrada" },
	{ "", "Valor inválido! Conflito de tipos: Rele Interno <-> Saída" },
	{ "", "Valor:" },
	{ "", "value: %d\\r\\n" },
	{ "", "var" },
	{ "", "Variação Velocidade" },
...
static LangTable LangTrTable[] = {
    ...
    { "Can only assign pin number to input/output pins or general variable.", "Sadece giriþ/çýkýþ uçlarý için bacak tanýmlamasý yapýlabilir." },
    ...
    { "POPTools - Simulation (Running)", "POPTools - Simülasyon (Çalýþýyor)" },
    { "POPTools - Simulation (Stopped)", "POPTools - Simülasyon (Durduruldu)" },
    { "POPTools - Program Editor", "POPTools – Program Editörü " },
    ...
    { "Insert Rung &Before\tShift+INS", "Üst kýsma satýr (Rung) ekle\tShift+INS" },
    { "Insert Rung &After\tINS", "Alt kýsma satýr (Rung) ekle\tINS" },
    ...
    { "Insert Co&mment\tF2", "Açýklama Ekle\tF2" },
    ...
    { "Insert CT&U (Count Up)\tI", "CT&U ekle (Yukarý Sayýcý)\tU" },
    { "Insert CT&D (Count Down)\tU", "CT&D ekle (Aþaðý Sayýcý)\tI" },
    ...
    { "POPTools Error", "POPTools Hatasý" },
