...
static LangTable LangDeTable[] = {
    ...
    { "Insert Rung &After\tCtrl+INS", "Netzwerk Einfügen &Danach\tCtrl+INS" },
    ...
    { "Insert OSR (One Shot Rising)\tCtrl+", "OSR einfügen (Steigende Flanke)\tCtrl+" },
    { "Insert OSF (One Shot Falling)\tCtrl-", "OSF einfügen (Fallende Flanke)\tCtrl-" },
...
static LangTable LangEsTable[] = {
    ...
    { "Insert Rung &After\tCtrl+INS", "Insertar Línea (Rung) &Despues\tCtrl+INS" },
    ...
    { "Insert OSR (One Shot Rising)\tCtrl+", "Insertar OSR (Flanco de Subida)\tCtrl+" },
    { "Insert OSF (One Shot Falling)\tCtrl-", "Insertar OSF (Flanco de Bajada)\tCtrl-" },
...
static LangTable LangFrTable[] = {
    ...
    { "Insert Rung &After\tCtrl+INS", "Insérer ligne &après\tCtrl+INS" },
    ...
    { "Insert OSR (One Shot Rising)\tCtrl+", "Insérer OSR (Front montant)\tCtrl+" },
    { "Insert OSF (One Shot Falling)\tCtrl-", "Insérer OSF (Front descendant)\tCtrl-" },
...
static LangTable LangItTable[] = {
    ...
    { "Insert Rung &After\tCtrl+INS", "Inserire Ramo &Dietro\tCtrl+INS" },
    ...
    { "Insert OSR (One Shot Rising)\tCtrl+", "Inserire PULSUP (Fronte di salita)\tCtrl+" },
    { "Insert OSF (One Shot Falling)\tCtrl-", "Inserire PULSDW (Fronte di discesa)\tCtrl-" },
...
static LangTable LangPtTable[] = {
    ...
    { "Insert Rung &After\tCtrl+INS", "Inserir Linha (Rung) &Depois\tCtrl+INS" },
    ...
    { "Insert Co&mment\tF2", "Inserir Co&mentário\tF2" },
    { "Insert &Contacts\tC", "Inserir &Contatos\tC" },
    { "Insert OSR (One Shot Rising)\tCtrl+", "Inserir OSR (Detecta Borda de Subida)\tCtrl+" },
    { "Insert OSF (One Shot Falling)\tCtrl-", "Inserir OSF (Detecta Borda de Descida)\tCtrl-" },
...
static LangTable LangTrTable[] = {
    ...
    { "Insert Rung &After\tCtrl+INS", "Alt kýsma satýr (Rung) ekle\tCtrl+INS" },
    ...
    { "Insert OSR (One Shot Rising)\tCtrl+", "OSR ekle (Yükselen Kenar)\tCtrl+" },
    { "Insert OSF (One Shot Falling)\tCtrl-", "OSF ekle (Düþen Kenar)\tCtrl-" },
