...
//  struct ethernetif *ethernetif = netif->state;
  ...
  netif->hwaddr[5] = mac_addr[5]; // MYMAC_1;
  netif->hwaddr[4] = mac_addr[4]; // MYMAC_2;
  netif->hwaddr[3] = mac_addr[3]; // MYMAC_3;
  netif->hwaddr[2] = mac_addr[2]; // MYMAC_4;
  netif->hwaddr[1] = mac_addr[1]; // MYMAC_5;
  netif->hwaddr[0] = mac_addr[0]; // MYMAC_6;
  ...
  semEthTx = CoCreateSem(ENET_NUM_TX_DESC, ENET_NUM_TX_DESC, 1);
  semEthRx = CoCreateSem(0, ENET_NUM_RX_DESC, 1);
