...
char *HelpText[] = {
    ...
    "",
    "Uma série de diferenças são evidentes:",
    "",
    ...
    "",
    "As variáveis são sempre inteiros de 16 bit. Isto significa que eles podem ir",
    ...
    "                                  ----] [----     ----] [----    ----] [----",
    "",
    "    Se o sinal que vai para a instrução for falsa, então o sinal de saída é falso.",
    "    Se o sinal que vai para a instrução é verdadeira,",
    "    então o sinal de saída é verdadeira se e somente se a porta de entrada de dados,",
    "    porta de saída, interna ou relê for verdadeira, então ela é falsa. Este",
    "    instrução pode examinar o estado de uma porta de entrada, uma porta de saída,",
    "    ou um relê interno.",
    "",
    "",
    ...
    "                                 ----]/[----     ----]/[----    ----]/[----",
    "",
    "    Se o sinal que vai para a instrução for falsa, então o sinal da saída é falso.",
    "    Se o sinal que vai para a instrução é verdadeira,",
    "    então o sinal de saída é verdadeira se e somente se a porta de entrada de dados,",
    "    porta de saída ou relê interno é falso, então ela é falsa. Esta",
    "    instrução pode examinar o estado de uma porta de entrada, uma porta de saída,",
    "    ou um relê interno. Isto é o oposto de um contato normalmente aberto.",
    "",
    "",
    "> BOBINA, NORMAL                  Rname           Yname",
    "                               ----( )----     ----( )----",
    "",
    "    Se o sinal que vai para a instrução for falsa, então o ",
    "    relé interno ou porta de saída está desmarcada falso. Se o sinal enviado",
    "    para esta instrução é verdadeira, então o relé interno ou a porta de saída",
    "    é definido como verdade. Não faz sentido atribuir uma variável de entrada para uma",
    "    bobina. Esta instrução deve ser a instrução mais a direita na linha.",
    "",
    "",
    ...
    "integer between -2147483648 and 2147483647. It also mean that the intermediate",
    ...
    "2147483647 + 1 = -2147483648). When possible, choose units that put values in",
