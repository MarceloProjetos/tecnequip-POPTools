...
void setLanguage(unsigned int id)
{
	...
	if(id == 1) { // Idioma Inglês
		...
		addTextToLangTable(l, "Saída Digital", "Pin on MCU");
		...
		addTextToLangTable(l, "(GMT-01:00) Açores, Cabo Verde", "(GMT-01:00) Açores, Cabo Verde");
		addTextToLangTable(l, "(GMT-02:00) Atlântico Central", "(GMT-02:00) Atlântico Central");
		addTextToLangTable(l, "(GMT-03:00) Brasilia, Buenos Aires", "(GMT-03:00) Brasilia, Buenos Aires");
		addTextToLangTable(l, "(GMT-04:00) Rio Branco, Manaus, Caracas, La Paz", "(GMT-04:00) Rio Branco, Manaus, Caracas, La Paz");
		addTextToLangTable(l, "(GMT-05:00) Lima, Bogotá", "(GMT-05:00) Lima, Bogotá");
		addTextToLangTable(l, "(GMT-06:00) América Central, Hora Central EUA/Canadá", "(GMT-06:00) América Central, Hora Central EUA/Canadá");
		addTextToLangTable(l, "(GMT-07:00) Hora das Montanhas (EUA e Canadá)", "(GMT-07:00) Hora das Montanhas (EUA e Canadá)");
		addTextToLangTable(l, "(GMT-08:00) Hora do Pacífico", "(GMT-08:00) Hora do Pacífico");
		addTextToLangTable(l, "(GMT-09:00) Alasca", "(GMT-09:00) Alasca");
		addTextToLangTable(l, "(GMT-10:00) Hawaí", "(GMT-10:00) Hawaí");
		addTextToLangTable(l, "(GMT-11:00) Ilhas Midway,Samoa", "(GMT-11:00) Ilhas Midway,Samoa");
		addTextToLangTable(l, "(GMT-12:00) Linha de Data Internacional Oeste", "(GMT-12:00) Linha de Data Internacional Oeste");
		addTextToLangTable(l, "(GMT 00:00) Hora de Greenwich: Londres, Dublin, Lisboa", "(GMT 00:00) Hora de Greenwich: Londres, Dublin, Lisboa");
		addTextToLangTable(l, "(GMT+01:00) Berlim, Estocolmo, Roma, Bruxelas", "(GMT+01:00) Berlim, Estocolmo, Roma, Bruxelas");
		addTextToLangTable(l, "(GMT+02:00) Atenas, Helsinque, Leste Europeu, Jerusalém", "(GMT+02:00) Atenas, Helsinque, Leste Europeu, Jerusalém");
		addTextToLangTable(l, "(GMT+03:00) Bagdá, Kuwait, Nairóbi, Moscou,Riad", "(GMT+03:00) Bagdá, Kuwait, Nairóbi, Moscou,Riad");
		addTextToLangTable(l, "(GMT+04:00) Abu Dhabi, Mascate, Hora Padrão do Cáucaso", "(GMT+04:00) Abu Dhabi, Mascate, Hora Padrão do Cáucaso");
		addTextToLangTable(l, "(GMT+05:00) Islamabad, Karachi, Ekaterinburgo", "(GMT+05:00) Islamabad, Karachi, Ekaterinburgo");
		addTextToLangTable(l, "(GMT+06:00) Almaty, Dacca", "(GMT+06:00) Almaty, Dacca");
		addTextToLangTable(l, "(GMT+07:00) Bangcoc, Jacarta, Hanói", "(GMT+07:00) Bangcoc, Jacarta, Hanói");
		addTextToLangTable(l, "(GMT+08:00) Pequim, Hong Kong, Taiwan, Cingapura", "(GMT+08:00) Pequim, Hong Kong, Taiwan, Cingapura");
		addTextToLangTable(l, "(GMT+09:00) Tóquio, Osaka, Sapporo, Seul, Yakutsk", "(GMT+09:00) Tóquio, Osaka, Sapporo, Seul, Yakutsk");
		addTextToLangTable(l, "(GMT+10:00) Brisbane, Camberra, Melbourne, Sydney", "(GMT+10:00) Brisbane, Camberra, Melbourne, Sydney");
		addTextToLangTable(l, "(GMT+11:00) Magadã, Ilhas Salomão, Nova Caledônia", "(GMT+11:00) Magadã, Ilhas Salomão, Nova Caledônia");
		addTextToLangTable(l, "(GMT+12:00) Fiji, Kamchatka, Auckland", "(GMT+12:00) Fiji, Kamchatka, Auckland");
		addTextToLangTable(l, "(GMT+13:00) Nuku'alofa", "(GMT+13:00) Nuku'alofa");
		...
		addTextToLangTable(l, "Arquivos de Texto (*.txt)\0*.txt\0Todos os Arquivos\0*\0\0", "Text files (*.txt)\0*.txt\0All Files\0*\0\0");
		...
		addTextToLangTable(l, "Dia da Semana", "Day of the Week");
		addTextToLangTable(l, "Dia do Mês", "Day of the Month");
		...
		addTextToLangTable(l, "Linguagem C (*.c)\0*.c\0Todos os Arquivos\0*\0\0", "C Language (*.c)\0*.c\0All files\0*\0\0");
		...
		addTextToLangTable(l, "Projeto POPTools (*.ld)\0*.ld\0Todos os Arquivos\0*\0\0", "POPTools Project (*.ld)\0*.ld\0All files\0*\0\0");
		...
		addTextToLangTable(l, "Write Encoder", "Escrever no Encoder");
		addTextToLangTable(l, "ler USS", "read USS");
		...
		addTextToLangTable(l, "Resolução DA (mV)[-10000 ~ 10000]", "D/A Resolutikon (mV)[-10000 ~ 10000]");
		...
		addTextToLangTable(l, "About...", "Sobre...");
		...
		addTextToLangTable(l, "Operator 1", "Operador 1");
		addTextToLangTable(l, "Operator 2", "Operador 2");
		addTextToLangTable(l, "Square Root", "Raiz Quadrada");
		addTextToLangTable(l, "start series [", "iniciando serie [");
