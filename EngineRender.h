...
public:
	...
	virtual void DrawRectangle(RECT r, unsigned int brush, bool filled = true, unsigned int radiusX = 0, unsigned int radiusY = 0)=0;
	virtual HRESULT DrawEllipse(POINT center, float rx, float ry, unsigned int brush, bool filled = true)=0;
	virtual void DrawText(char *txt, RECT r, unsigned int format, unsigned int brush)=0;
