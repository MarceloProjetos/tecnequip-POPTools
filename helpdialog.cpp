...
static char *AboutText[] = {
	...
	"=============",
	"",
	"POPtools é um editor de lógica ladder, simulador e compilador para placas POP7 e POP9 da Tecnequip. Pode gerar o código nativo para POP7 e POP9  a partir do ladder ",
	"Para maiores informações entre em contato no site",
	"",
