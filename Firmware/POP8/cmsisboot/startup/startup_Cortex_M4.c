...
void WEAK  UNUSED_IRQHandler(void);
...
void WEAK  SDCARD_IRQHandler(void);
...
{	
  ...
  UART4_IRQHandler,          /*!< 35: UART4                                   */
  SSP2_IRQHandler,           /*!< 36: SSP2                                    */
  LCD_IRQHandler,            /*!< 37: LCD Controller                          */
  GPIO_IRQHandler,           /*!< 38: GPIO                                    */
  PWM0_IRQHandler,           /*!< 39: PWM0                                    */
  EEPROM_IRQHandler,         /*!< 40: EEPROM                                  */
};
...
#pragma weak SDCARD_IRQHandler = Default_Handler
