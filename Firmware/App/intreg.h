...
#define INTREG_MACADDRESS_START (INTREG_VARCOUNT_START + INTREG_VARCOUNT_SIZE)
#define INTREG_MACADDRESS_SIZE  3
#define INTREG_RESERVED_START   (INTREG_MACADDRESS_START + INTREG_MACADDRESS_SIZE)
#define INTREG_RESERVED_SIZE    (100 - INTREG_RESERVED_START)
