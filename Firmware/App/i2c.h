...
extern unsigned int I2C_Init( unsigned int I2cMode );
extern unsigned int I2C_InitFast( unsigned int I2cMode );
extern unsigned int I2C_Start( void );
extern unsigned int I2C_Stop( void );
